...
export default function MySpecs({ bodyColor }) {
  return (
    <SpecWrapper bodyColor={bodyColor}>
        ...
        <div className="row">
          <div className="col-10 mx-auto col-md-6 my-3">
            ...
            >
              <div
                data-aos="fade-right"
                className="text-center mx-auto col-12 col-md-12 col-sm-12 my-2
my-3 spec-icon"
              >
                <img
                  className="img-fluid"
              ...
              <div
                data-aos="fade-left"
                className="text-center mx-auto col-12 col-md-12 col-sm-12 my-3
my-3 spec-icon"
              >
                <img
                  className="img-fluid"
 ...
 my-3 spec-icon"
              >
                <img
                  ...
                  style={{ height: "200px", width: "200px" }}
                />
                <div className="text-title py-2">NodeJS</div>
              </div>
            </div>
          </div>
        </div>
